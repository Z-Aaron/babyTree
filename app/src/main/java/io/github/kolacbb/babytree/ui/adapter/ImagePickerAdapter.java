...
import io.github.kolacbb.babytree.ui.activity.SendTimeLineActivity;
    ...
    public class SelectedPicViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(int position) {
            ...
            if (isAdded && position == getItemCount() - 1) {
                ...
                clickPosition = SendTimeLineActivity.IMAGE_ITEM_ADD;
            } else {
                ImagePicker.getInstance().getImageLoader().displayImage((Activity) mContext, item.path, iv_img, 200, 200);
